  ...
  return (
    <div className="min-w-0">
      ...
      <div className="mt-8 sm:mt-12 bg-white p-5 sm:p-8 rounded-2xl border border-gray-100 shadow-sm">
        <h2 className="text-lg font-bold mb-4">Welcome to Telex Admin</h2>
        <p className="text-gray-600 leading-relaxed max-w-3xl">
          This dashboard monitors the Telex architecture: direct-custody wallets, payment orchestration, KYC, audit logs, and system health. All payments settle on Stellar.
        </p>
      </div>
    </div>
  );
