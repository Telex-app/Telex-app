const catalog = {
  en: {
    welcome_help: 'Telex can help with send money, receive money, balance, contacts, transaction history, and receipts.',
    balances_header: 'Your Telex balances:\n{lines}',
    receive_header: 'Share one of these to receive money on Telex:\n{lines}',
    ...
    opt_in_success: 'You have opted in to receive Telex messages and updates. Reply STOP to opt out.',
  ...
  fr: {
    welcome_help: 'Telex peut vous aider à envoyer de l\'argent, recevoir de l\'argent, consulter votre solde, vos contacts, l\'historique des transactions et vos reçus.',
    balances_header: 'Vos soldes Telex :\n{lines}',
    receive_header: 'Partagez l\'une de ces adresses pour recevoir de l\'argent sur Telex :\n{lines}',
    ...
    opt_in_success: 'Vous avez accepté de recevoir les messages et mises à jour Telex. Répondez STOP pour vous désabonner.',
  ...
  es: {
    welcome_help: 'Telex puede ayudarle a enviar dinero, recibir dinero, consultar saldo, contactos, historial de transacciones y recibos.',
    balances_header: 'Sus saldos de Telex:\n{lines}',
    receive_header: 'Comparta una de estas direcciones para recibir dinero en Telex:\n{lines}',
    ...
    opt_in_success: 'Ha optado por recibir mensajes y actualizaciones de Telex. Responda STOP para darse de baja.',
