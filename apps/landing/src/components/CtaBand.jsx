...
export default function CtaBand() {
  return (
    <section className="container mx-auto px-4 pb-16 sm:px-6 lg:pb-24">
      <div className="relative overflow-hidden rounded-3xl bg-dark px-6 py-14 text-center sm:px-12 dark:bg-night-card dark:ring-1 dark:ring-night-border">
        <div
          aria-hidden="true"
